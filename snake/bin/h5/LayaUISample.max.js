...
var Animation=(function(_super){
	...
	*/
	...
	__proto._parseGraphicAnimation=function(animationData){
		return GraphicAnimation$1.parseAnimationData(animationData);
	}

	/**@private */
	__proto._parseGraphicAnimationByData=function(animationObject){
		return GraphicAnimation$1.parseAnimationByData(animationObject);
	}
...
var GraphicAnimation$1=(function(_super){
	var GraphicNode;
	...
	__class(GraphicAnimation,'laya.utils.GraphicAnimation',_super,'GraphicAnimation$1');
...
var RedbagGotUI=(function(_super){
	...
	Laya.__init([LoaderManager,EventDispatcher,Browser,Render,View,LocalStorage,Timer,GraphicAnimation$1]);
	/**LayaGameStart**/
	new LayaUISample();
